  ...
  loop do
    ...
    while STDIN.ready?
      if !STDIN.eof?
        ...
        elsif data["func"] == "conference_turn"
        ...
        elsif data["func"] == "conference_accept"
          if $conference != nil && data["userid"].is_a?(Integer)
        ...
        elsif data["func"] == "conference_callingplay"
          $conference.calling_play if $conference != nil
        elsif data["func"] == "conference_callingstop"
        ...
        elsif data["func"] == "feedid"
          $feed_id = data["feedid"]
        elsif data["func"] == "feedreset"
          $ag_feed = 0
          $ag_feedtime = 0
          $feeds = {}
          $feedstime = 0
          $lastfeeds = nil
        elsif data["func"] == "recording"
