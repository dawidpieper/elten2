...
$tekst = "";
while ($wiersz = mysql_fetch_row($idzapytania)){
$tekst .= "<a href=forum.php?forum=1&forumname=" . $wiersz[0] . "&title=" . $wiersz[0] . ">" . $wiersz[0] . "</a><br>";
$wiersze = $wiersze + 1;
}
...
$maxid = 0;
while ($wiersz = mysql_fetch_row($idzapytania)){
$tekst .= "<h3><a href=\"forum.php?forum=2&forumname=". $_GET['forumname'] . "&threadid=" . $wiersz[0] . "&title=" . $wiersz[1] . "\">" . $wiersz[1] . "</a></h3>";
...
echo "<h3>Nowy temat</h3><form action=forum.php?forum=".$_GET['forum']."&forumname=".$_GET['forumname']."&threadid=".($maxid+1)." method=POST>Tytuł wątku:<br><input name=threadname><br>Treść pierwszego wpisu:<br><textarea name=post cols=100 rows=20></textarea><input type=submit value=Dodaj></form>";
}
}
if($_GET['forum'] == 2)
{
...
if($_SESSION['login'] != NULL)
echo "<h3>Nowy wpis</h3><form action=forum.php?forum=".$_GET['forum']."&forumname=".$_GET['forumname']."&threadid=".$_GET['threadid']." method=POST>Treść wpisu:<br><textarea name=post cols=100 rows=20></textarea><input type=submit value=Dodaj></form>";
}
}
require("footer.php");
