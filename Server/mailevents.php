...
Elten Support Team
";
mail($r[2], "=?ISO8859-2?B?" . base64_encode("Elten - Mail verification!") . "?=", $body, $head);
echo "0";
}
else {
...
Elten Support Team
";
mail($r[2], "=?ISO8859-2?B?" . base64_encode("Elten - Mail events reporting disabling!") . "?=", $body, $head);
echo "0";
}
else {
