...
class Scene_Chat
  def main
    ...
    speech_wait if $chat!=true
        @form=Form.new([Edit.new(p_("Chat", "Your message"),"","",true),Edit.new(p_("Chat", "Messages history"),"MULTILINE|READONLY"," ",true),Select.new([],true,0,p_("Chat", "Users online"),true),Button.new(p_("Chat", "Hide the chat window")),Button.new(_("Exit"))])
