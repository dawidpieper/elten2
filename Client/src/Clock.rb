                                            ...
                                            if enter and @form.index==0
                                              editalarm(@form.fields[0].index)
                                                ...
                                                for i in 0..59
                                                  ...
                                                  form=Form.new([ListBox.new(c[0..23],p_("Clock", "Hour"),a[0],0,true),ListBox.new(c[0..59],p_("Clock", "Minute"),a[1],0,true),ListBox.new([p_("Clock", "One time"),p_("Clock", "Repeated")],p_("Clock", "Type"),a[2],0,true),EditBox.new(p_("Clock", "Alarm description"), "", a[3]),Button.new(_("Save")),Button.new(_("Cancel"))])
                                                  loop do
                                                    loop_update
                                                      form.update
