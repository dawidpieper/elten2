...
class Scene_Portable
  def main
    @form=Form.new([FilesTree.new(p_("Portable", "Destination"),getdirectory(40),true,true,"Documents"),CheckBox.new(p_("Portable", "Copy current settings")),CheckBox.new(p_("Portable", "Copy downloaded soundthemes")),CheckBox.new(p_("Portable", "Create as a single exe file. (No settings will be saved.")),Button.new(p_("Portable", "continue")),Button.new(_("Cancel"))])    
loop do
  loop_update
  @form.update
