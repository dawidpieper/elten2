...
class Scene_Interface
  def main
    ...
    @field[3] = CheckBox.new("Automatycznie minimalizuj okno programu do zasobnika systemowego")
        @field[4] = CheckBox.new("Uruchamiaj program w trybie pełnoekranowym")
    @field[5] = CheckBox.new("Włącz automatyczne logowanie")
        @field[6]=CheckBox.new("Automatycznie uruchamiaj program Elten przy starcie systemu")
...
@form.fields[3].checked = readini($configdata + "\\interface.ini","Interface","HideWindow","0").to_i
...
writeini($configdata + "\\interface.ini","Interface","HideWindow",@form.fields[3].checked.to_s)
...
$interface_hidewindow = @form.fields[3].checked.to_i
